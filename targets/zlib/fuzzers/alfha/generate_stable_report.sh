...
echo "🔍 ALFHA zlib Stable Coverage Report Generator"
echo "=============================================="
...
if [ ${#PROFILE_FILES[@]} -eq 0 ]; then
    echo "❌ No valid profile files found"
    echo "Please run ./run_stable_coverage.sh first"
    exit 1
fi

echo "📊 Found ${#PROFILE_FILES[@]} stable profiles to merge:"
...
echo "✅ Merged profile: ${merged_size} bytes"
...
echo "📋 Using $(basename "$REFERENCE_BINARY") as reference"
echo ""
...
echo "✅ Stable coverage report completed!"
echo ""
echo "📊 Coverage Summary:"
echo "$TOTAL_COVERAGE"
echo ""
echo "📁 Generated files:"
echo "  📄 Summary: $REPORT_DIR/stable_summary.txt"
echo "  📋 Detailed: $REPORT_DIR/stable_detailed.txt"  
